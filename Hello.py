...
def run():
    ...
    def numlock_clicked(video_container):
        st.markdown(
            '''<iframe width='462' height='822' src='https://www.youtube.com/embed/1bvtlQJ17qo?autoplay=1' 
    ...
    div[data-testid='stHorizontalBlock'] div[data-testid='column']:nth-child(1) div[data-testid='element-container']:nth-child(1) button {
        background-color: #fcd53f;
    }
    
    /* Division button */
    div[data-testid='stHorizontalBlock'] div[data-testid='column']:nth-child(2) div[data-testid='element-container']:nth-child(1) button p {
        font-size: 18px;
    }
    div[data-testid='stHorizontalBlock'] div[data-testid='column']:nth-child(2) div[data-testid='element-container']:nth-child(1) button {
        background-color: #00d26a;
    }

    /* Multiplication button */
    div[data-testid='stHorizontalBlock'] div[data-testid='column']:nth-child(3) div[data-testid='element-container']:nth-child(1) button p {
        font-size: 18px;
    }
    div[data-testid='stHorizontalBlock'] div[data-testid='column']:nth-child(3) div[data-testid='element-container']:nth-child(1) button {
        background-color: #00d26a;
    }
    
    /* Minus button */
    div[data-testid='stHorizontalBlock'] div[data-testid='column']:nth-child(4) div[data-testid='element-container']:nth-child(1) button p {
        font-size: 18px;
    }
    div[data-testid='stHorizontalBlock'] div[data-testid='column']:nth-child(4) div[data-testid='element-container']:nth-child(1) button {
        background-color: #00d26a;
    }    
